...
%>
        ...
        <tbody>
        <%
      	ResultSet rs = st.executeQuery("select * from product, cart where product.id=cart.product_id and cart.email='"+email+"' and cart.address is NULL");
      	while(rs.next())
      	{
      	%>
          <tr>
...
<div class="right-div">
<h3>Pay online on this ayonroy@pay.com</h3>
